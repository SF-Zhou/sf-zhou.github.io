...
最近出于工作需要，准备看完 [BeeGFS v7.2.5](https://git.beegfs.io/pub/v7/-/tree/f85c4a62b4b4de0efd6ca9789a634b20604ee8f6) 的代码，写点分析。代码规模在 20 万行左右，分为几个大模块。笔者无法很好地预测之后每篇博客能覆盖的主题，所以标题就随心所欲吧。
